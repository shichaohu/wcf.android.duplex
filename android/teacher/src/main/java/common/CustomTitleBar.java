...
public class CustomTitleBar extends LinearLayout {
    ...
    /*
        ...
        * param 
        * create by  朝虎
        * time 2017/6/11 20:44
    */
    public CustomTitleBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        /**加载布局文件*/
        LayoutInflater.from(context).inflate(R.layout.pub_titlebar, this, true);
        ll = (LinearLayout) findViewById(R.id.share_tb_ll);
        left_button = (TextView) findViewById(R.id.share_tb_left_button);
        right_button = (TextView) findViewById(R.id.share_tb_right_button);
        title = (TextView) findViewById(R.id.share_tb_title);
